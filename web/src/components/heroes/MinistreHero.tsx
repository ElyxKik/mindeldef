...
export default function MinistreHero({
  title,
  subtitle,
  height = "medium",
  cta,
  ...
  // Utilise l'image du ministre pour cette page spécifique
  const imageSrc = "/images/ministere/ministre-photo.jpeg";
  const imageAlt = "Portrait du Ministre délégué à la Défense";
