    ...
    <>
      ...
      <Section>
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold mb-6 text-slate-900">Aide Sociale et Financière</h2>
          
          <div className="space-y-8">
            {/* Allocations */}
            <div className="bg-white rounded-lg p-6 border border-slate-200">
              <h3 className="text-2xl font-bold mb-3 text-red-600">Allocations Mensuelles</h3>
            ...
            {/* Housing */}
            <div className="bg-white rounded-lg p-6 border border-slate-200">
              <h3 className="text-2xl font-bold mb-3 text-red-600">Aide au Logement</h3>
              <p className="text-slate-700 mb-4">
            ...
            <div className="bg-white rounded-lg p-6 border border-slate-200">
              <h3 className="text-2xl font-bold mb-3 text-red-600">Formation Professionnelle</h3>
              <p className="text-slate-700 mb-4">
            ...
            {/* Microfinance */}
            <div className="bg-white rounded-lg p-6 border border-slate-200">
              <h3 className="text-2xl font-bold mb-3 text-red-600">Microfinance et Entrepreneuriat</h3>
              <p className="text-slate-700 mb-4">
          ...
          {/* Application Process */}
          <div className="mt-12 bg-slate-50 rounded-lg p-8 border border-slate-200">
            <h2 className="text-2xl font-bold mb-6 text-slate-900">Comment Postuler?</h2>
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="font-semibold text-slate-900">Préparez vos documents</h3>
                  <p className="text-slate-700 text-sm">Carte d'identité, certificat de service, documents médicaux si applicable</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="flex-shrink-0">
                ...
                <div className="ml-4">
                  <h3 className="font-semibold text-slate-900">Contactez notre direction</h3>
                  <p className="text-slate-700 text-sm">Rendez-vous ou appel pour soumettre votre demande</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="flex-shrink-0">
                ...
                <div className="ml-4">
                  <h3 className="font-semibold text-slate-900">Évaluation de votre dossier</h3>
                  <p className="text-slate-700 text-sm">Notre équipe examine votre demande (délai: 2-4 semaines)</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="flex-shrink-0">
                ...
                <div className="ml-4">
                  <h3 className="font-semibold text-slate-900">Approbation et versement</h3>
                  <p className="text-slate-700 text-sm">Notification de l'approbation et début des versements</p>
                </div>
              </div>
            </div>
          </div>
