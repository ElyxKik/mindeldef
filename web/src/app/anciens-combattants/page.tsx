    ...
    <>
      ...
      <Section>
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold mb-6 text-slate-900 dark:text-white">Reconnaissance et Soutien</h2>
      ...
      {/* Programs Section */}
      <Section>
        <h2 className="text-3xl font-bold mb-12 text-slate-900 dark:text-white">Nos Programmes</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Program 1 */}
          <div className="bg-white dark:bg-slate-800 rounded-lg p-8 border border-slate-200 dark:border-slate-700 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-2xl font-bold mb-3 text-slate-900 dark:text-white">Aide Sociale</h3>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg p-8 border border-slate-200 dark:border-slate-700 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-2xl font-bold mb-3 text-slate-900 dark:text-white">Soins de Santé</h3>
            <p className="text-slate-600 dark:text-slate-300 mb-4">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg p-8 border border-slate-200 dark:border-slate-700 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-2xl font-bold mb-3 text-slate-900 dark:text-white">Reconnaissance</h3>
            <p className="text-slate-600 dark:text-slate-300 mb-4">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg p-8 border border-slate-200 dark:border-slate-700 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-2xl font-bold mb-3 text-slate-900 dark:text-white">Communauté</h3>
            <p className="text-slate-600 dark:text-slate-300 mb-4">
      ...
      <Section className="bg-slate-50 dark:bg-slate-900 py-12">
        <h2 className="text-3xl font-bold mb-12 text-center text-slate-900 dark:text-white">Chiffres Clés</h2>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="text-center">
            <div className="text-4xl font-bold text-red-600 dark:text-red-400 mb-2">80K+</div>
            <p className="text-slate-600 dark:text-slate-300">Anciens Combattants</p>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-red-600 dark:text-red-400 mb-2">60+</div>
            <p className="text-slate-600 dark:text-slate-300">Ans de Service</p>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-red-600 dark:text-red-400 mb-2">26</div>
          ...
          <div className="text-center">
            ...
            <p className="text-slate-600 dark:text-slate-300">Engagement</p>
          </div>
        </div>
      </Section>
