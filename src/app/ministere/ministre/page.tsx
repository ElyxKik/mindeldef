...
export default function Page() {
  return (
    <>
      {/* Hero section avec photo du ministre */}
      <div className="relative h-[40vh] min-h-[320px] max-h-[480px] w-full overflow-hidden">
        ...
        <Image
          src="/images/placeholder-minister.jpg"
        ...
        <div className="relative z-20 h-full flex flex-col justify-end">
          <div className="container mx-auto px-4 pb-12">
            <h1 className="text-white text-4xl md:text-5xl font-bold mb-4">
              Le Ministre délégué à la Défense
            </h1>
            <p className="text-white/90 text-xl max-w-2xl">
              S.E. [Nom du Ministre], Ministre délégué à la Défense de la République Démocratique du Congo
            </p>
          </div>
        </div>
      </div>
